...
const EditProfile = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      //check to make sure if loading or no profile
      organisation:
        loading || !profile.organisation ? '' : profile.organisation,
  ...
  return (
    <Fragment>
      <h1 className='large text-dark'>
        <i className='fas fa-user'></i> Set up Profile
      </h1>
      <p className='lead'>Strengthen your profile</p>
